...
const Privacy = () => {
    ...
    const [currentVersion, setCurrentVersion] = useState<string>('4.1');
        ...
        <main className="tracking-wide font-roboto min-h-screen grid content-start dark:bg-gray-900">
            ...
            <div className="container mx-auto px-6 py-8 max-w-4xl">
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">2. How We Use Your Information</h2>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">3. Cookies and Tracking Technologies</h2>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                        ...
                        <h3 className="text-xl font-medium text-gray-800 dark:text-gray-200 mb-3">Types of Cookies We Use</h3>
                        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 mb-4 ml-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">4. Third-Party Services</h2>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                            We may use third-party services to monitor and analyze the use of our website:
                        </p>
                        <h3 className="text-xl font-medium text-gray-800 dark:text-gray-200 mb-3">Google Analytics</h3>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                            Google Analytics is a web analytics service offered by Google that tracks and reports website traffic. Google uses the data collected to track and monitor the use of our website. This data is shared with other Google services.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">5. Data Security</h2>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">6. Children's Privacy</h2>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">7. Changes to This Privacy Policy</h2>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">8. Your Rights</h2>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                            If you have any questions about this Privacy Policy, please contact us through our website or by visiting our contact page.
                        </p>
                    </section>
