...
const InfoTable = ({ table } : { table : string[][] }) => {
    ...
    const parseText = (text: string): any => {
        if(text.includes("rgb(") || text === "transparent")
        {
            ...
            return <div className="w-6 h-6 border rounded" style={{backgroundColor: cleanText}}></div>
        }
                                        ...
                                        return (
                                            <td
                                                ...
                                                className={classNames('cursor-copy font-mono text-xs hover:underline p-2', {
                                                    'text-purple-700 dark:text-purple-300 break-words': index === 0,
                                                    'text-blue-700 dark:text-blue-300 break-words': index === 1,
